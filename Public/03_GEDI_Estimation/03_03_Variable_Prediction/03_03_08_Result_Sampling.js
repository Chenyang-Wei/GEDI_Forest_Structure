 ...
 * Introduction *
 * 
 *  1) Obtain the estimated response variables at 
...
var wd_Main_2_Str = ENA_mod.wd_GEE_Str;
...
// Randomly collected samples (10 per grid cell).
...
// Select properties of interest from the collected samples.
collectedSamples_FC = collectedSamples_FC
  .select(selectedVarNames_List.concat(["Tile_ID", "Sample_ID"]));
...
if (!export_Bool) {
  ...
  var outputName_Str = "SampledEstimates_Raw";
