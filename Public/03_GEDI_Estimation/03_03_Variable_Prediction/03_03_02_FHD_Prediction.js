...
for (var responseVarID_Num = 0; responseVarID_Num < 1; 
  ...
  for (var startIndex_Num = 1000; startIndex_Num < 1700; 
    startIndex_Num += tileNumber_Num) { // (For "FHD".)
